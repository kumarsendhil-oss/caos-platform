...
### Prepared for Venture Assist / Srivatsan & Associates | v0.2.7
...
| Software Development Proposal (customer-facing) | Complete — **v0.3 (2026-09-21)** carries the commercial terms: a fixed price of ₹15,00,000 exclusive of GST against milestones M1–M4, a 120-day post-go-live warranty, training, defect severity levels, and the licence and ownership model (new §10). **Not to be sent to the client yet** — its §9 recurring-cost estimate is still priced on a Supabase/Railway stack, contrary to ADR 0007/0009 (`PENDING:038`) | v0.3 |
