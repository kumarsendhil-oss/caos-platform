...
### Prepared for Venture Assist / Srivatsan & Associates | v0.2
...
| Architecture | See Architecture Decision Records (10 original ADRs + ADR 0011) |
...
|---|---|---|---|
| PRD (this document) | In progress | v0.2 | 2026-08-22 |
| Feature Backlog (MoSCoW + phase mapping) | Complete (107 features, xlsx with Summary sheet) | v0.2 | 2026-08-22 |
| Architecture Decision Records | In progress (10 original ADRs + ADR 0011; DPDP legal specifics, IaC tooling, and extension-point pattern still open) | v0.1 + ADR 0011 addendum | 2026-08-22 |
| ER Diagram | Complete (2 diagrams: core platform, compliance & billing — 23 entities, BOOKS_CONNECTION generalized) | v0.2 | 2026-08-22 |
| API Spec | Complete — endpoints across 12 domains, Books Connections retitled and Zoho OAuth endpoints added | v0.2 | 2026-08-22 |
| Coding Guidelines | Complete — CG1–CG11, CG7 generalized across both adapters | v0.2 | 2026-08-22 |
| Logging Standard | Complete — no changes required by ADR 0011 | v0.1 | 2026-08-16 |
| Testing Strategy | Complete — mock boundary and critical flow #1 extended to cover the Zoho adapter | v0.2 | 2026-08-22 |
| Security Standard | Complete — Zoho OAuth credential storage and rotation-model note added | v0.2 | 2026-08-22 |
| Performance & Scaling | Complete — no changes required by ADR 0011 | v0.1 | 2026-08-16 |
...
| Tech Stack Decision | Drafted as ADR 0007 (Proposed — Python/FastAPI backend, AWS Mumbai hosting) | v0.1 | 2026-08-16 |
| Sprint Plan | Complete — Phase 0 (+ Zoho spike) + 12 sprints (~27 weeks, timeline pending Phase 0 spike confirmation) | v0.2 | 2026-08-22 |
| Dev Readiness Checklist | Complete — 44 items across 6 categories | v0.1 | 2026-08-22 |
...
- ZB-03 Push approved draft entries (from the Bookkeeping Agent) into Zoho Books as Bills or Journal Entries — Zoho's own tax-component fields carry the CGST/SGST/IGST breakdown, the functional equivalent of a Tally voucher's ledger split. The same duplicate-prevention check (CG7) runs before this write, identical in principle to the Tally path.
...
- BK-08 Duplicate-prevention check runs before posting — verified that neither Tally's XML import nor Zoho's write API prevents duplicate entries on its own, so the platform must check for an existing entry (matching vendor GSTIN + invoice number + date) before posting, not rely on either backend to catch it
...
5. Complete the Dev Readiness Checklist before Sprint 1 begins.
